    ...
    >
      ...
      <PageSection icon={IconWorld} title="Third parties">
        <p>
          ...
          The OpenSky Network, adsbdb and aviationstack, are made by the server
          and do not include anything about you. The exception is map imagery:
          with a tile map style your browser loads tiles directly from Esri,
          which sees your IP address and the areas you look at. If you use the
          locate button, your position is read by your browser to move the map
